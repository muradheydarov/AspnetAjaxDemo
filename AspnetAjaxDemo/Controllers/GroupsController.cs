...
namespace AspnetAjaxDemo.Controllers
{
    public class GroupsController : Controller
    {
        ...
        public ActionResult GetAllUsers(int groupId)
        {            
            var selectedUsers = db.Students.Where(x => x.GroupId == groupId).ToList();
            ...
            var json = JsonConvert.SerializeObject(selectedUsers);
